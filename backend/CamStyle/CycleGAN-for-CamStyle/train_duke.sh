...
python train.py --dataroot ./datasets/duke --name duke-c1-c7 --camA 1 --camB 7
python train.py --dataroot ./datasets/duke --name duke-c1-c8 --camA 1 --camB 8
...
python train.py --dataroot ./datasets/duke --name duke-c2-c7 --camA 2 --camB 7
python train.py --dataroot ./datasets/duke --name duke-c2-c8 --camA 2 --camB 8

python train.py --dataroot ./datasets/duke --name duke-c3-c4 --camA 3 --camB 4
...
python train.py --dataroot ./datasets/duke --name duke-c3-c7 --camA 3 --camB 7
python train.py --dataroot ./datasets/duke --name duke-c3-c8 --camA 3 --camB 8
...
python train.py --dataroot ./datasets/duke --name duke-c4-c7 --camA 4 --camB 7
python train.py --dataroot ./datasets/duke --name duke-c4-c8 --camA 4 --camB 8

python train.py --dataroot ./datasets/duke --name duke-c5-c6 --camA 5 --camB 6
python train.py --dataroot ./datasets/duke --name duke-c5-c7 --camA 5 --camB 7
python train.py --dataroot ./datasets/duke --name duke-c5-c8 --camA 5 --camB 8

python train.py --dataroot ./datasets/duke --name duke-c6-c7 --camA 6 --camB 7
python train.py --dataroot ./datasets/duke --name duke-c6-c8 --camA 6 --camB 8

python train.py --dataroot ./datasets/duke --name duke-c7-c8 --camA 7 --camB 8
